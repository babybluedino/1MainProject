...
public class TicketsController {
	...
	@GetMapping("/{ticketId}")
	public ResponseEntity<Tickets> findByTicketId(@PathVariable("ticketId") Long ticketId) {
		
		ResponseEntity<Tickets> resp;
		
		Tickets tkt_return = tktservice.findByTicketId(ticketId);
	...
	public ResponseEntity<List<Tickets>> findByTicketval(@PathVariable("status") TicketStatus status) {
		
		ResponseEntity<List<Tickets>> resp;
		
		List<Tickets> tkt_return = tktservice.findByStatus(status);
	...
	public ResponseEntity<Integer> getOpenTicketcount(){
		...
		List<Tickets> tkt= tktservice.findByStatus(TicketStatus.Open);
		int c=tkt.size();
	...
	public ResponseEntity<Integer> getClosedTicketcount(){
		
		ResponseEntity<Integer> resp = null;
		
		List<Tickets> tkt= tktservice.findByStatus(TicketStatus.Closed);
		int c=tkt.size();
		Integer it=new Integer(c);
		return new ResponseEntity<>(it,HttpStatus.OK);		
