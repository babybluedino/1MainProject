...
public class TicketsServiceImpl implements TicketsService{
	...
	@Override
	public List<Tickets> findByStatus(TicketStatus status) {
		
		List<Tickets> ticket = tktdao.findByStatus(status);
		return ticket;
	}
	
	@Override
	public Tickets findByTicketId(Long ticketId) {
		
		Tickets ticket = tktdao.findByTicketId(ticketId);
		return ticket;
	}
